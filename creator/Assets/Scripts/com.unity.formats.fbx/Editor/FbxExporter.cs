...
namespace UnityEditor.Formats.Fbx.Exporter
{
    ...
    public sealed class ModelExporter : System.IDisposable
    {
                                    ...
                                    FbxSurfaceMaterial fbxMaterial, string fbxPropName)
        {
            ...
            Debug.Log("unityTexture::" + unityTexture);
            Debug.Log("textureSourceFullPath::" + textureSourceFullPath);
            Debug.Log("filep::" + LastFilePath);
        ...
        bool ExportMesh (MeshInfo meshInfo, FbxNode fbxNode)
        {
            ...
            Debug.Log("meshInfo:::" + meshInfo);
            Debug.Log("fbxNode:::" + fbxNode);
        ...
        private bool ExportInstance(GameObject unityGo, FbxScene fbxScene, FbxNode fbxNode)
        {
            ...
            Debug.Log("unityGoMesh::" + unityGoMesh);
        ...
        )
        {
            ...
            using (var fbxExporter = Create ()) {
                ...
                if (fbxExporter.ExportAll (objects, exportData) > 0) {
                    fbxExporter.ExportImages(filePath);
        ...
        internal bool ExportImages (string filePath) {
            // Debug.Log("TextureMap:::" + TextureMap.Keys);
            string directoryName = filePath.Substring(0, filePath.LastIndexOf("/"));
            foreach (string key in TextureMap.Keys)
            {
                string fileName = key.Substring(key.LastIndexOf("\\"));
                // AssetDatabase.CopyAsset(key, "D:/WhiteHat/testImage/");
                string str = directoryName+fileName;
                if (File.Exists(str)) {
                    File.Delete(str);
                }
                File.Copy(key , str);
