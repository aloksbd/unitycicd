...
public class NewDoor : NewItemWithMesh, IHas3DObject, NewIFlipable
{
    ...
    public NewDoor(GameObject gameObject, UIItem uiItem) : base(gameObject, uiItem) { }
    ...
    public override CreatorItem Clone()
    {
        ...
        CreatorItem clone = new NewDoor(GameObject.Instantiate(gameObject), new UIItem(name));
